...
public class Catalog {
	...
	public Catalog setProducts(Products[] products) {
		this.products = products;
		return this;
	}
	...
	public static class Products {
		...
		public Products setCatalogName(String catalogName) {
			this.catalogName = catalogName;
			return this;
		}
		...
		public Products setNumber(String number) {
			this.number = number;
			return this;
		}
		...
		public Products setQuoteCriteria(QuoteCriteria[] quoteCriteria) {
			this.quoteCriteria = quoteCriteria;
			return this;
		}
